...
const contentItems: ContentItem[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        title:
          '5. Will any of my stars carry forward from one season to another?',
        content: [
...
export { contentItems, tocTitles, type Link, type StarAllocationData }
